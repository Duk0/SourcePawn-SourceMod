...
{
	CreateConVar("dod_medic_version", PLUGIN_VERSION, "DoD Medic Version", FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);
	cvarhealthmaximum = CreateConVar("dod_medic_health_maximum", "30", "Maximum Health left to be able to use !medic");
	cvarhealthtogive = CreateConVar("dod_medic_health_give", "40", "Amount of health to give when !medic is used");
...
{
	new dead = GetEntProp(client, Prop_Data, "m_lifeState");
