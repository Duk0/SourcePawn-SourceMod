...
public OnPluginStart() {
	CreateConVar("sm_dod_equipment_version", PLUGIN_VERSION, "DoD Equipment", FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);
	g_Cvar_enabled = CreateConVar("sm_equip_enabled", "1", "Enable or disable the DoD:S Equipment plugin.");

	// Rifleman class
	g_Cvar_rifleClearGer = CreateConVar("sm_equip_rifle_clear_ger", "", "Remove all German rifleman weapons?");
	g_Cvar_rifleEquipGer = CreateConVar("sm_equip_rifle_equip_ger", "", "What weapons to give the German rifleman.");
	g_Cvar_rifleAmmoGer = CreateConVar("sm_equip_rifle_ammo_ger", "", "How much ammo to get each new weapon for the German rifleman. (Separate each ammo # by a space. IE, \"40 10 12\")");
	g_Cvar_rifleClearUS = CreateConVar("sm_equip_rifle_clear_us", "", "Remove all U.S. rifleman weapons?");
	g_Cvar_rifleEquipUS = CreateConVar("sm_equip_rifle_equip_us", "", "What weapons to give the U.S. rifleman.");
	g_Cvar_rifleAmmoUS = CreateConVar("sm_equip_rifle_ammo_us", "", "How much ammo to get each new weapon for the U.S. rifleman. (Separate each ammo # by a space. IE, \"40 10 12\")");

	// Assault class
	g_Cvar_assaultClearGer = CreateConVar("sm_equip_assault_clear_ger", "", "Remove all German assault weapons?");
	g_Cvar_assaultEquipGer = CreateConVar("sm_equip_assault_equip_ger", "", "What weapons to give the German assault.");
	g_Cvar_assaultAmmoGer = CreateConVar("sm_equip_assault_ammo_ger", "", "How much ammo to get each new weapon for the German assault. (Separate each ammo # by a space. IE, \"40 10 12\")");
	g_Cvar_assaultClearUS = CreateConVar("sm_equip_assault_clear_us", "", "Remove all U.S. assault weapons?");
	g_Cvar_assaultEquipUS = CreateConVar("sm_equip_assault_equip_us", "", "What weapons to give the U.S. assault.");
	g_Cvar_assaultAmmoUS = CreateConVar("sm_equip_assault_ammo_us", "", "How much ammo to get each new weapon for the U.S. assault. (Separate each ammo # by a space. IE, \"40 10 12\")");

	// Support class
	g_Cvar_supportClearGer = CreateConVar("sm_equip_support_clear_ger", "", "Remove all German support weapons?");
	g_Cvar_supportEquipGer = CreateConVar("sm_equip_support_equip_ger", "", "What weapons to give the German support.");
	g_Cvar_supportAmmoGer = CreateConVar("sm_equip_support_ammo_ger", "", "How much ammo to get each new weapon for the German support. (Separate each ammo # by a space. IE, \"40 10 12\")");
	g_Cvar_supportClearUS = CreateConVar("sm_equip_support_clear_us", "", "Remove all U.S. support weapons?");
	g_Cvar_supportEquipUS = CreateConVar("sm_equip_support_equip_us", "", "What weapons to give the U.S. support.");
	g_Cvar_supportAmmoUS = CreateConVar("sm_equip_support_ammo_us", "", "How much ammo to get each new weapon for the U.S. support. (Separate each ammo # by a space. IE, \"40 10 12\")");

	// Sniper class
	g_Cvar_sniperClearGer = CreateConVar("sm_equip_sniper_clear_ger", "", "Remove all German sniper weapons?");
	g_Cvar_sniperEquipGer = CreateConVar("sm_equip_sniper_equip_ger", "", "What weapons to give the German sniper.");
	g_Cvar_sniperAmmoGer = CreateConVar("sm_equip_sniper_ammo_ger", "", "How much ammo to get each new weapon for the German sniper. (Separate each ammo # by a space. IE, \"40 10 12\")");
	g_Cvar_sniperClearUS = CreateConVar("sm_equip_sniper_clear_us", "", "Remove all U.S. sniper weapons?");
	g_Cvar_sniperEquipUS = CreateConVar("sm_equip_sniper_equip_us", "", "What weapons to give the U.S. sniper.");
	g_Cvar_sniperAmmoUS = CreateConVar("sm_equip_sniper_ammo_us", "", "How much ammo to get each new weapon for the U.S. sniper. (Separate each ammo # by a space. IE, \"40 10 12\")");

	// MG class
	g_Cvar_mgClearGer = CreateConVar("sm_equip_mg_clear_ger", "", "Remove all German MG weapons?");
	g_Cvar_mgEquipGer = CreateConVar("sm_equip_mg_equip_ger", "", "What weapons to give the German MG.");
	g_Cvar_mgAmmoGer = CreateConVar("sm_equip_mg_ammo_ger", "", "How much ammo to get each new weapon for the German MG. (Separate each ammo # by a space. IE, \"40 10 12\")");
	g_Cvar_mgClearUS = CreateConVar("sm_equip_mg_clear_us", "", "Remove all U.S. MG weapons?");
	g_Cvar_mgEquipUS = CreateConVar("sm_equip_mg_equip_us", "", "What weapons to give the U.S. MG.");
	g_Cvar_mgAmmoUS = CreateConVar("sm_equip_mg_ammo_us", "", "How much ammo to get each new weapon for the U.S. MG. (Separate each ammo # by a space. IE, \"40 10 12\")");

	// Rocket class
	g_Cvar_rocketClearGer = CreateConVar("sm_equip_rocket_clear_ger", "", "Remove all German rocket weapons?");
	g_Cvar_rocketEquipGer = CreateConVar("sm_equip_rocket_equip_ger", "", "What weapons to give the German rocket.");
	g_Cvar_rocketAmmoGer = CreateConVar("sm_equip_rocket_ammo_ger", "", "How much ammo to get each new weapon for the German rocket. (Separate each ammo # by a space. IE, \"40 10 12\")");
	g_Cvar_rocketClearUS = CreateConVar("sm_equip_rocket_clear_us", "", "Remove all U.S. rocket weapons?");
	g_Cvar_rocketEquipUS = CreateConVar("sm_equip_rocket_equip_us", "", "What weapons to give the U.S. rocket.");
	g_Cvar_rocketAmmoUS = CreateConVar("sm_equip_rocket_ammo_us", "", "How much ammo to get each new weapon for the U.S. rocket. (Separate each ammo # by a space. IE, \"40 10 12\")");
