...
new String:g_szSoundUSWin[] = "czsk_veterans/russian.mp3"
new String:g_szSoundGermanWin[] = "czsk_veterans/german.mp3"

new Handle:g_VictoryMusic = INVALID_HANDLE

public OnPluginStart()
{
	g_VictoryMusic = CreateConVar("dod_victorymusic", "1", "<1/0> = enable/disable changing the victory music", _, true, 0.0, true, 1.0)
...
{
	if (GetConVarInt(g_VictoryMusic) == 0)
