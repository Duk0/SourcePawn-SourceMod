...
public OnPluginStart()
{
	...
	g_hFireworksTimeout = CreateConVar("sm_fireworks_timeout", "60.0", "Fireworks running seconds");
	g_hFireworksSound = CreateConVar("sm_fireworks_sound", "1", "Fireworks sounds (0/1)");
	g_hFireworksRoundend = CreateConVar("sm_fireworks_roundend","1", "Fireworks at round end (0/1)");
